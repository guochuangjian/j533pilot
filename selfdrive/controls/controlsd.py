...
class Controls:
  ...
  def publish_logs(self, CS, start_time, actuators, v_acc, a_acc, lac_log):
    ...
    print("[PONTEST][controlsd.py][publish_logs()] bool(is_vag_fulltime_lka_disabled_with_blinker and (CS.leftBlinker or CS.rightBlinker))=", bool(is_vag_fulltime_lka_disabled_with_blinker and (CS.leftBlinker or CS.rightBlinker)))
    print("[PONTEST][controlsd.py][publish_logs()] bool(is_vag_fulltime_lka_disable_with_brake and CS.brakePressed)=", bool(is_vag_fulltime_lka_disable_with_brake and CS.brakePressed))
